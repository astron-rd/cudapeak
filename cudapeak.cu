...
void run_compute_sp_ai() {
    ...
    double gflops = (1e-6 * globalBlocks * workPerBlock);
    double gbytes = (1e-6 * globalBlocks * workPerBlock) * sizeof(float);
