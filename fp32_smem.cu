    ...
    cudaDeviceProp deviceProperties)
{
    ...
    unsigned nrRepetitions = 1024;
    unsigned fetchPerBlock = 512;
    ...
    report("flop:byte ->   1:1", milliseconds, gflops, gbytes/1);
    ...
    report("flop:byte -> 128:1", milliseconds, gflops, gbytes/128);
