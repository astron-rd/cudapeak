...
#include "kernels/fp32_sincos_sfu.cu.o.h"

int main(int argc, const char *argv[]) {
  Benchmark benchmark(argc, argv);

  KernelFactory kernel_factory(fp32_sincos_sfu_source);

  const std::vector<std::string> kernel_names{
      "fp32_sincos_sfu_1_8",  "fp32_sincos_sfu_1_4",  "fp32_sincos_sfu_1_2",
      "fp32_sincos_sfu_1_1",  "fp32_sincos_sfu_2_1",  "fp32_sincos_sfu_4_1",
      "fp32_sincos_sfu_8_1",  "fp32_sincos_sfu_16_1", "fp32_sincos_sfu_32_1",
      "fp32_sincos_sfu_64_1", "fp32_sincos_sfu_128_1"};
